...
CREATE TABLE ws3_match_simulation (
  ...
  age TINYINT(2) NULL,
  w_handling TINYINT(3) NULL,
  w_tackling TINYINT(3) NULL,
  w_passing TINYINT(3) NULL,
  w_finishing TINYINT(3) NULL,
  w_pace TINYINT(3) NULL,
...
('Goal', '<b>Goal scored by {sp1}!</b>'),
('Goal', '<b>{sp1} shoots... GOAL!</b>'),
('Goal', '<b>GOAL - Beautifully done by {sp1}</b>'),
('Goal', '<b>{sp1} takes a shot... And scores!</b>'),
('Substitution', '<i>{sp1} comes on for {sp2}.</i>'),
('Tackle_won', '{sp1} runs towards his opponent and wins the tackle!'),
('Tackle_won', '{sp1} with a tackle... and wins it!'),
('Tackle_lost', '{sp1} tries to disposses {sp2}... but he loses out.'),
('Pass_missed', '{sp1} passes towards the centre, but it goes straight to an opponent.'),
('Pass_missed', 'Pass by {sp1}... but he misplaces it.'),
('Shot_missed', '{sp1} with a great chance... But puts it over the bar'),
('Shot_missed', '{sp1} shoots... Well wide.'),
('Shot_missed', 'Header by {sp1}... but it goes wide.'),
('Shot_on_target', '{sp1} shoots... Great save by the keeper!'),
('Shot_on_target', '{sp1} with a shot at goal... But the goalkeeper makes a diving save and holds the ball.'),
('Shot_on_target', '{sp1} is clear of the defence... but the keeper gets down well and turns it around the post.'),
('Yellow_card', '{sp1} gets the yellow card after a foul.'),
('Yellow_card_2nd', '<i>{sp1} recieves a second yellow and is sent off!</i>'),
('Red_card', '<i>{sp1} is shown a red card after a horrendous foul.</i>'),
('Injury', '<i>{sp1} is injured and has to be carried off.</i>'),
('Penalty_scored', '{sp1} with the penalty. GOAL!'),
('Penalty_missed', '{sp1} with the penalty. But {sp2} saves it!'),
('Penalty_missed', '{sp1} places the ball on the spot. He steps up, but blasts it over the bar!'),
('Tactics_changed', '{sp1} changes the tactics.'),
('Corner', 'Corner for {ma1}. {sp1} plays it to {sp2}...'),
('Freekick_missed', 'Free-kick for {ma1}! {sp1} shoots, but misses the target.'),
('Freekick_scored', '{sp1} with a direct free-kick. GOAL!'),
('Goal_with_assist', 'Goal for {ma1}! {sp2} with the pass to {sp1}, who taps the ball in.');
