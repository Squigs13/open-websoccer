...
/**
 * A new simulation strategy which simulates actions by probabilities, depending on the teams' tactic and players' strength.
 * 
 * @author James Quigley
 */
class JQSimulationStrategy implements ISimulationStrategy {
